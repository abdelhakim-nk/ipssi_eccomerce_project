      ...
      <div className="basket">
        <div className="basket-list">
          <div className="basket-header">
            <h3 className="basket-header-title">
              Mon panier &nbsp;
              <span>
                ({` ${basket.length} ${basket.length > 1 ? "item" : "produit"}`}
                )
              </span>
            </h3>
            <BasketToggle>
            ...
            <button
              ...
              type="button"
            >
              <span>Effacer le panier</span>
            </button>
          </div>
          {basket.length <= 0 && (
            <div className="basket-empty">
              <h5 className="basket-empty-msg">Votre panier est vide</h5>
            </div>
          )}
        ...
        <div className="basket-checkout">
          <div className="basket-total">
            <p className="basket-total-title">Total du panier:</p>
