...
const CategorieAppliedFilters = ({ filteredCategoriesCount }) => {
        ...
        <div className="product-list-header-title">
          <h5>
            {filteredCategoriesCount > 0
              && `Found ${filteredCategoriesCount} ${filteredCategoriesCount > 1 ? 'products' : 'product'}`}
          </h5>
        </div>
      </div>
...
CategorieAppliedFilters.defaultProps = {
  filteredCategoriesCount: 0
};

CategorieAppliedFilters.propTypes = {
  filteredCategoriesCount: PropType.number
};

export default CategorieAppliedFilters;
