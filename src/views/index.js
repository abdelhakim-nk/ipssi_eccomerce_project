...
export { default as Categories } from './admin/categorie';
export { default as AddCategorie } from './admin/add_categorie';
export { default as EditCategorie } from './admin/edit_categorie';
