...
const OrderSummary = ({ basket, subtotal }) => {
  useDocumentTitle("Check Out Step 1 | SNKRS Paris");
  useScrollTop();
  ...
  return (
    <div className="checkout">
      ...
      <div className="checkout-step-1">
        <h3 className="text-center">Récapitulatif de la commande</h3>
        <span className="d-block text-center">Produit dans votre panier</span>
        <br />
