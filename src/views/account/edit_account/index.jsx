...
const EditProfile = () => {
  useDocumentTitle("Modifier le compte | SNKRS Paris");
  useScrollTop();
  ...
  const onSubmitUpdate = (form) => {
    ...
    const fieldsChanged = Object.keys(form).some(
      (key) => profile[key] !== form[key]
    );
  ...
  return (
    <Boundary>
      <div className="edit-user">
        <h3 className="text-center">Modifier son profil - Details</h3>
        <Formik
