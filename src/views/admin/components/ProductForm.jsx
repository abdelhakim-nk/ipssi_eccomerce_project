        ...
        {({ values, setValues }) => (
          <Form className="product-form">
            <div className="product-form-inputs">
              <div className="d-flex">
                ...
                <div className="product-form-field">
                  <CustomCreatableSelect
                    ...
                    disabled={isLoading}
                    placeholder="Sélectionner/Créer une marque"
                    label="* Marque"
                  />
                </div>
              </div>
              ...
              <div className="d-flex">
                <div className="product-form-field">
                  <CustomCreatableSelect
                    ...
                    isMulti
                    disabled={isLoading}
                    placeholder="Sélectionner/Créer un mot clé"
                    label="* Mot clé"
                  />
                </div>
                &nbsp;
                <div className="product-form-field">
                  <CustomCreatableSelect
                    ...
                    isMulti
                    disabled={isLoading}
                    placeholder="Sélectionner/Créer une pointure"
                    label="* Pointure"
                  />
                </div>
              </div>
              ...
              <div className="product-form-field">
                <span className="d-block padding-s">Image du produit</span>
                {!isFileLoading && (
              ...
              <div className="product-form-field product-form-submit">
                ...
                >
                  ...
                  &nbsp;
                  {isLoading ? 'Saving Product' : 'Enregistrer le produit'}
                </button>
              </div>
            </div>
            {/* ----THUBMNAIL ---- */}
            <div className="product-form-file">
              <div className="product-form-field">
                <span className="d-block padding-s">* Miniature</span>
                {!isFileLoading && (
